...
const undergraduateScholarships = [
  {
    ...
    deadline: 'مارس 2024',
    benefits: ['إعفاء كامل من الرسوم', 'مكافأة شهرية مجزية', 'سكن جامعي مؤمن', 'تأمين صحي شامل'],
    rating: 'امتياز'
  },
  {
    id: 2,
...
const graduateScholarships = [
  {
    ...
    deadline: 'يناير 2024',
    benefits: ['إعفاء كامل من الرسوم', 'مكافأة سنوية تصل إلى 30,000 دولار', 'سكن عائلي', 'دعم للأسرة والتأمين الصحي'],
    rating: 'ممتاز جدًا'
  },
  {
    id: 4,
