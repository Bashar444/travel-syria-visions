  ...
  return (
    ...
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            ...
            <nav className="flex flex-col sm:flex-row gap-4" role="navigation" aria-label="Main action buttons">
              <Button 
                size="lg"
                className="bg-white text-[#1e40af] hover:bg-blue-50 font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <Button 
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-[#1e40af] font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base lg:text-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
          ...
          <aside className="relative" role="complementary" aria-label="Success statistics">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-blue-200/30">
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-6 text-center text-blue-200">
                <strong>Our Success Statistics</strong>
              </h2>
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-blue-200">
