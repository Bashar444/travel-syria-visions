          ...
          <div className={direction === 'rtl' ? 'text-right' : 'text-left'}>
            ...
            <div className="space-y-3">
              <button
                ...
                className="flex items-center space-x-2 rtl:space-x-reverse text-gray-300 hover:text-[#EE3524] transition-colors group"
              >
              ...
              <Link 
                to="/contact"
                className="block text-gray-300 hover:text-[#EE3524] transition-colors"
              >
                نموذج الاتصال
              </Link>
            </div>
